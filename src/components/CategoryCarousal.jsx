    ...
    <>
      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <Slider {...settings} className="category-slider pb-10">
          <CategoryCircle icon={BeefIcon} title="Beef" />
          <CategoryCircle icon={ChickenIcon} title="Chicken" />
          <CategoryCircle icon={MuttonIcon} title="Mutton" />
          <CategoryCircle icon={SeafoodIcon} title="Seafood" />
          <CategoryCircle icon={TurkeyIcon} title="Turkey" />
          <CategoryCircle icon={ReadyToCookIcon} title="Ready-to-Cook" />
